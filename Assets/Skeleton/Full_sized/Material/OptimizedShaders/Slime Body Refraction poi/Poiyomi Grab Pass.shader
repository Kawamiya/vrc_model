Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Grab Pass/14ae29dce6b6adc4389ce6101e512123"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 grabpassBlur(float2 uv)
			{
				...
				float2 radius = (0.02 /*_GrabBlurDistance*/) / _ScreenParams.xy * 100; // Arbitrary constant to match old blurring
				float quality = floor((6.0 /*_GrabBlurQuality*/));
				float directions = floor((7.0 /*_GrabBlurDirections*/));
			...
			inline float4 Refraction(float indexOfRefraction, float chromaticAberration, float2 projectedGrabPos, in PoiMesh poiMesh, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				if ((20.0 /*_RefractionFalloff*/) > 0)
				{
					float falloff = smoothstep((20.0 /*_RefractionFalloff*/), 0, distance(poiMesh.worldPos, poiCam.worldPos));
			...
			void calculateGrabpass(float2 projectedGrabPos, inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				{
					grabpassColor = Refraction((1.0 /*_RefractionIndex*/), (0.0 /*_RefractionChromaticAberattion*/), projectedGrabPos, poiMesh, poiCam, poiMods).rgb;
				}
				else
				{
					#ifdef CHROMATIC_ABERRATION_LOW
				...
				#endif
				float blendFactor = (0.477 /*_GrabPassBlendFactor*/) * blendMap;
				...
				poiFragData.finalColor = poiBlend((0.0 /*_GrabSrcBlend*/), float4(poiFragData.finalColor, poiFragData.alpha), (1.0 /*_GrabDstBlend*/), float4(grabpassColor, 1), blendFactor);
			}
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				switch((1.0 /*_MatcapUVMode*/))
				{
					case 0:
					{
						...
						matcapUV = noSknewViewNormal.rg * (0.357 /*_MatcapBorder*/) + 0.5;
						break;
					}
					case 1:
					{
						...
						matcapUV = float2(dot(worldViewRight, normal0), dot(worldViewUp, normal0)) * (0.357 /*_MatcapBorder*/) + 0.5;
						break;
					}
					case 2:
					{
						...
						matcapUV = uv * (0.357 /*_MatcapBorder*/) + 0.5;
						break;
					}
				}
				...
				#endif
				matcap.rgb *= (0.82 /*_MatcapIntensity*/);
				...
				{
					matcap.rgb = hueShift(matcap.rgb, (0.326 /*_MatcapHueShift*/) + _Time.x * (0.0 /*_MatcapHueShiftSpeed*/));
				}
				blendMatcap(poiLight, poiFragData, poiMods, (0.104 /*_MatcapAdd*/), (0.0 /*_MatcapAddToLight*/), (0.578 /*_MatcapMultiply*/), (0.641 /*_MatcapReplace*/), (0.0 /*_MatcapMixed*/), (0.0 /*_MatcapScreen*/), matcap, matcapMask, (0.0 /*_MatcapEmissionStrength*/), (0.292 /*_MatcapLightMask*/), (0.0 /*_MatcapMaskGlobalMask*/), (2.0 /*_MatcapMaskGlobalMaskBlendType*/));
				#endif
			}
			#endif
			...
			{
				float smoothness = (0.776 /*_MochieRoughnessMultiplier*/);
				float smoothness2 = (1.0 /*_MochieRoughnessMultiplier2*/);
				float metallic = (0.639 /*_MochieMetallicMultiplier*/);
			...
			void poiClearCoat(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				float smoothness = (0.0 /*_ClearCoatSmoothness*/);
				float reflectionMask = (0.25 /*_ClearCoatReflectionStrength*/);
				float specularMask = (0.35 /*_ClearCoatSpecularStrength*/);
				#if defined(PROP_CLEARCOATMAPS) || !defined(OPTIMIZER_ENABLED)
				...
				{
					percepRough = GSAA_Filament(poiMesh.normals[(0.0 /*_ClearCoatNormalSelect*/)], percepRough, (0.218 /*_ClearCoatGSAAVariance*/), (0.1 /*_ClearCoatGSAAThreshold*/));
				}
				float brdfRoughness = percepRough * percepRough;
				brdfRoughness = max(brdfRoughness, 0.002);
				float3 diffuse = 0;
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				{
					poiLight.directColor = min(poiLight.directColor, (0.9 /*_LightingCap*/));
					poiLight.indirectColor = min(poiLight.indirectColor, (0.9 /*_LightingCap*/));
				}
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.07339612,0.0526484,0.3047196,0).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.07339612,0.0526484,0.3047196,0).a;
				...
				#endif
				ApplyLiltoonRimLighting(poiFragData, poiMesh, poiCam, poiLight, poiMods, float4(0.5152035,0.5152035,0.5152035,1), float4(1,1,1,1), rimColorTex, (0.0 /*_RimMainStrength*/), (1.0 /*_RimNormalStrength*/), (0.0 /*_RimDirRange*/), (0.0 /*_RimIndirRange*/), (1.7 /*_RimFresnelPower*/), (1 /*_RimBackfaceMask*/), (0.0 /*_RimDirStrength*/), (0.571 /*_RimBorder*/), (0.13 /*_RimBlur*/), (0.5 /*_RimIndirBorder*/), (0.1 /*_RimIndirBlur*/), (0.0 /*_RimShadowMask*/), (0.326 /*_RimEnableLighting*/), (1.0 /*_RimVRParallaxStrength*/), (0.0 /*_RimGlobalMask*/), (2.0 /*_RimGlobalMaskBlendType*/), (0.0 /*_RimHueShiftEnabled*/), (0.0 /*_RimHueShift*/), (0.0 /*_RimHueShiftSpeed*/), (0.0 /*_RimClamp*/));
				#endif
				#endif
				...
				clip(poiFragData.alpha - (0.22 /*_Cutoff*/));
