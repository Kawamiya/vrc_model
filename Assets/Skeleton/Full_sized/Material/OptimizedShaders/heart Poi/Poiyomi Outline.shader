Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon Outline/b0171acc945b0e74aa884365f022ced5"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				lightMap.x *= lerp(1.0, poiLight.attenuation, (0.3 /*_ShadowReceive*/));
				lightMap.y *= lerp(1.0, poiLight.attenuation, (0.2 /*_Shadow2ndReceive*/));
				lightMap.z *= lerp(1.0, poiLight.attenuation, (0.0 /*_Shadow3rdReceive*/));
				if ((1.0 /*_LightingMulitlayerNonLinear*/))
				{
					lns.x = poiEdgeNonLinearNoSaturate(lightMap.x, (0.25 /*_ShadowBorder*/), (0.08 /*_ShadowBlur*/) * blurMap.r);
					lns.y = poiEdgeNonLinearNoSaturate(lightMap.y, (0.0 /*_Shadow2ndBorder*/), (0.3 /*_Shadow2ndBlur*/) * blurMap.g);
					lns.z = poiEdgeNonLinearNoSaturate(lightMap.z, (0.072 /*_Shadow3rdBorder*/), (0.1 /*_Shadow3rdBlur*/) * blurMap.b);
					lns.w = poiEdgeNonLinearNoSaturate(lightMap.x, (0.25 /*_ShadowBorder*/), (0.08 /*_ShadowBlur*/) * blurMap.r, (0.15 /*_ShadowBorderRange*/));
				}
				else
				{
					lns.x = poiEdgeLinearNoSaturate(lightMap.x, (0.25 /*_ShadowBorder*/), (0.08 /*_ShadowBlur*/) * blurMap.r);
					lns.y = poiEdgeLinearNoSaturate(lightMap.y, (0.0 /*_Shadow2ndBorder*/), (0.3 /*_Shadow2ndBlur*/) * blurMap.g);
					lns.z = poiEdgeLinearNoSaturate(lightMap.z, (0.072 /*_Shadow3rdBorder*/), (0.1 /*_Shadow3rdBlur*/) * blurMap.b);
					lns.w = poiEdgeLinearNoSaturate(lightMap.x, (0.25 /*_ShadowBorder*/), (0.08 /*_ShadowBlur*/) * blurMap.r, (0.15 /*_ShadowBorderRange*/));
				}
				lns = saturate(lns);
				...
				indirectColor = lerp(indirectColor, 1, lns.w * float4(1,0.4865309,0.4865309,1).rgb);
			...
			float3 applyEmission(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				{
					emissionColor0 = POI2D_SAMPLER_PAN(_EmissionMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMapUV*/)], float4(1,1,0,0)), float4(0,0,0,0)).rgb * lerp(1, poiFragData.baseColor, (1.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, float4(16.52474,9.275681,9.275681,1).rgb, (0.0 /*_EmissionColorThemeIndex*/));
				}
				else
				{
					emissionColor0 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(1,1,0,0).xy) + _Time.x * (5.0 /*_EmissionCenterOutSpeed*/)).rgb * lerp(1, poiFragData.baseColor, (1.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, float4(16.52474,9.275681,9.275681,1).rgb, (0.0 /*_EmissionColorThemeIndex*/));
				}
				#else
				emissionColor0 = lerp(1, poiFragData.baseColor, (1.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, float4(16.52474,9.275681,9.275681,1).rgb, (0.0 /*_EmissionColorThemeIndex*/));
				#endif
				...
				{
					emissionStrength0 *= calculateBlinkingEmission((0.2 /*_EmissiveBlink_Min*/), (4.0 /*_EmissiveBlink_Max*/), (6.5 /*_EmissiveBlink_Velocity*/), (0.0 /*_EmissionBlinkingOffset*/));
				}
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				ApplyLiltoonRimLighting(poiFragData, poiMesh, poiCam, poiLight, poiMods, float4(0.5600193,0.3137766,0.2838186,0.5), float4(1,1,1,1), rimColorTex, (0.8 /*_RimMainStrength*/), (1.0 /*_RimNormalStrength*/), (0.0 /*_RimDirRange*/), (0.0 /*_RimIndirRange*/), (3.5 /*_RimFresnelPower*/), (1 /*_RimBackfaceMask*/), (0.0 /*_RimDirStrength*/), (0.5 /*_RimBorder*/), (0.2 /*_RimBlur*/), (0.5 /*_RimIndirBorder*/), (0.1 /*_RimIndirBlur*/), (0.5 /*_RimShadowMask*/), (1.0 /*_RimEnableLighting*/), (1.0 /*_RimVRParallaxStrength*/), (0.0 /*_RimGlobalMask*/), (2.0 /*_RimGlobalMaskBlendType*/), (0.0 /*_RimHueShiftEnabled*/), (0.0 /*_RimHueShift*/), (0.0 /*_RimHueShiftSpeed*/), (0.0 /*_RimClamp*/));
				#endif
				#endif
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyOutlineColor(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiMods poiMods, in PoiCam poiCam)
			{
				...
				poiFragData.baseColor *= float4(poiThemeColor(poiMods, float4(0.456411,0.1195384,0.1356333,1).rgb, (0.0 /*_LineColorThemeIndex*/)), float4(0.456411,0.1195384,0.1356333,1).a);
