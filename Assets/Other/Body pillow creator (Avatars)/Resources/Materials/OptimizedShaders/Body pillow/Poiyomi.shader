Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi Toon/bca6f143694fbcd4cb85fd7cdf2a3762"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyDecals(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiMods poiMods, in PoiLight poiLight)
			{
				...
				if (poiMods.audioLinkAvailable)
				{
					...
					sideMod += lerp(float4(0,0,0,0), float4(0,0,0,0), poiMods.audioLink[(0.0 /*_AudioLinkDecal0SideBand*/)]);
					decalRotation += lerp(float4(0,0,0,0).x, float4(0,0,0,0).y, poiMods.audioLink[(0.0 /*_AudioLinkDecal0RotationBand*/)]);
					decalRotation += AudioLinkGetChronoTime((0.0 /*_DecalRotationCTALType0*/), (0.0 /*_DecalRotationCTALBand0*/)) * (0.0 /*_DecalRotationCTALSpeed0*/) * 360;
				}
				#endif
				#if defined(PROP_DECALTEXTURE) || !defined(OPTIMIZER_ENABLED)
				uv = decalUV((0.0 /*_DecalTextureUV*/), float4(1,1,0,0), float4(0.5,0.5,0,0), (0.0 /*_DecalRotation*/) + decalRotation, (0.0 /*_DecalRotationSpeed*/), decalScale, float4(0,0,0,0) +sideMod, (0.0 /*_Decal0Depth*/), poiMesh, poiCam);
				ddxuv = ddx(uv);
				ddyuv = ddy(uv);
				if (any(fwidth(uv) > .5))
				{
				...
				decalColor = tex2D(_DecalTexture, uv + float4(0,0,0,0) * _Time.x, ddxuv, ddyuv) * float4(poiThemeColor(poiMods, float4(1,1,1,1).rgb, (0.0 /*_DecalColorThemeIndex*/)), float4(1,1,1,1).a);
				#else
				uv = decalUV((0.0 /*_DecalTextureUV*/), float4(1,1,0,0), float4(0.5,0.5,0,0), (0.0 /*_DecalRotation*/) + decalRotation, (0.0 /*_DecalRotationSpeed*/), decalScale, float4(0,0,0,0) +sideMod, (0.0 /*_Decal0Depth*/), poiMesh, poiCam);
				decalColor = float4(poiThemeColor(poiMods, float4(1,1,1,1).rgb, (0.0 /*_DecalColorThemeIndex*/)), float4(1,1,1,1).a);
				#endif
				decalColor.rgb = decalHueShift((0.0 /*_DecalHueShiftEnabled*/), decalColor.rgb, (0.0 /*_DecalHueShift*/) + poiLight.nDotV * (0.0 /*_Decal0HueAngleStrength*/), (0.0 /*_DecalHueShiftSpeed*/));
				decalColor.a *= applyTilingClipping((0.0 /*_DecalTiled*/), uv) * decalMask[(0.0 /*_Decal0MaskChannel*/)];
				float audioLinkDecalAlpha0 = 0;
				#ifdef POI_AUDIOLINK
				if ((0.0 /*_AudioLinkDecalCC0*/) && poiMods.audioLinkAvailable)
				{
					decalColor.rgb *= AudioLinkLerp(ALPASS_CCSTRIP + float2(uv.x * AUDIOLINK_WIDTH, 0)).rgb;
				}
				audioLinkDecalAlpha0 = lerp(float4(0,0,0,0).x, float4(0,0,0,0).y, poiMods.audioLink[(0.0 /*_AudioLinkDecal0AlphaBand*/)]) * poiMods.audioLinkAvailable;
				#endif
				poiFragData.baseColor.rgb = lerp(poiFragData.baseColor.rgb, customBlend(poiFragData.baseColor.rgb, decalColor.rgb, (0.0 /*_DecalBlendType*/)), decalColor.a * saturate((1.0 /*_DecalBlendAlpha*/) + audioLinkDecalAlpha0));
				if ((0.0 /*_DecalOverrideAlpha*/))
				{
					alphaOverride += 1;
					decalAlpha = lerp(decalAlpha, min(decalAlpha, decalColor.a), decalMask[(0.0 /*_Decal0MaskChannel*/)]);
				}
				float audioLinkDecalEmission0 = 0;
				#ifdef POI_AUDIOLINK
				audioLinkDecalEmission0 = lerp(float4(0,0,0,0).x, float4(0,0,0,0).y, poiMods.audioLink[(0.0 /*_AudioLinkDecal0EmissionBand*/)]) * poiMods.audioLinkAvailable;
				#endif
				poiFragData.emission += decalColor.rgb * decalColor.a * max((0.0 /*_DecalEmissionStrength*/) + audioLinkDecalEmission0, 0);
				#endif
				#ifdef GEOM_TYPE_BRANCH_DETAIL
				decalScale = float4(0.7,1.1,0,0);
				decalRotation = 0;
				sideMod = 0;
				#ifdef POI_AUDIOLINK
				if (poiMods.audioLinkAvailable)
				{
					decalScale += lerp(float4(0,0,0,0).xy, float4(0,0,0,0).zw, poiMods.audioLink[(0.0 /*_AudioLinkDecal1ScaleBand*/)]);
					sideMod += lerp(float4(0,0,0,0), float4(0,0,0,0), poiMods.audioLink[(0.0 /*_AudioLinkDecal1SideBand*/)]);
					decalRotation += lerp(float4(0,0,0,0).x, float4(0,0,0,0).y, poiMods.audioLink[(0.0 /*_AudioLinkDecal1RotationBand*/)]);
					decalRotation += AudioLinkGetChronoTime((0.0 /*_DecalRotationCTALType1*/), (0.0 /*_DecalRotationCTALBand1*/)) * (0.0 /*_DecalRotationCTALSpeed1*/) * 360;
				}
				#endif
				#if defined(PROP_DECALTEXTURE1) || !defined(OPTIMIZER_ENABLED)
				uv = decalUV((0.0 /*_DecalTexture1UV*/), float4(1,1,0.12,0), float4(0.63,0.25,0,0), (90.0 /*_DecalRotation1*/) + decalRotation, (0.0 /*_DecalRotationSpeed1*/), decalScale, float4(0,0,0,0) + sideMod, (0.0 /*_Decal1Depth*/), poiMesh, poiCam);
				ddxuv = ddx(uv);
				ddyuv = ddy(uv);
				if (any(fwidth(uv) > .5))
				{
				...
				decalColor = tex2D(_DecalTexture1, uv + float4(0,0,0,0) * _Time.x, ddxuv, ddyuv) * float4(poiThemeColor(poiMods, float4(1,1,1,1).rgb, (0.0 /*_DecalColor1ThemeIndex*/)), float4(1,1,1,1).a);
				#else
				uv = decalUV((0.0 /*_DecalTexture1UV*/), float4(1,1,0.12,0), float4(0.63,0.25,0,0), (90.0 /*_DecalRotation1*/) + decalRotation, (0.0 /*_DecalRotationSpeed1*/), decalScale, float4(0,0,0,0) + sideMod, (0.0 /*_Decal1Depth*/), poiMesh, poiCam);
				decalColor = float4(poiThemeColor(poiMods, float4(1,1,1,1).rgb, (0.0 /*_DecalColor1ThemeIndex*/)), float4(1,1,1,1).a);
				#endif
				decalColor.rgb = decalHueShift((0.0 /*_DecalHueShiftEnabled1*/), decalColor.rgb, (0.0 /*_DecalHueShift1*/) + poiLight.nDotV * (0.0 /*_Decal1HueAngleStrength*/), (0.0 /*_DecalHueShiftSpeed1*/));
				decalColor.a *= applyTilingClipping((0.0 /*_DecalTiled1*/), uv) * decalMask[(1.0 /*_Decal1MaskChannel*/)];
				float audioLinkDecalAlpha1 = 0;
				#ifdef POI_AUDIOLINK
				if ((0.0 /*_AudioLinkDecalCC1*/) && poiMods.audioLinkAvailable)
				{
					decalColor.rgb *= AudioLinkLerp(ALPASS_CCSTRIP + float2(uv.x * AUDIOLINK_WIDTH, 0)).rgb;
				}
				audioLinkDecalAlpha1 = lerp(float4(0,0,0,0).x, float4(0,0,0,0).y, poiMods.audioLink[(0.0 /*_AudioLinkDecal1AlphaBand*/)]) * poiMods.audioLinkAvailable;
				#endif
				poiFragData.baseColor.rgb = lerp(poiFragData.baseColor.rgb, customBlend(poiFragData.baseColor.rgb, decalColor.rgb, (0.0 /*_DecalBlendType1*/)), decalColor.a * saturate((1.0 /*_DecalBlendAlpha1*/) + audioLinkDecalAlpha1));
				if ((0.0 /*_DecalOverrideAlpha1*/))
				{
					alphaOverride += 1;
					decalAlpha = lerp(decalAlpha, min(decalAlpha, decalColor.a), decalMask[(1.0 /*_Decal1MaskChannel*/)]);
				}
				float audioLinkDecalEmission1 = 0;
				#ifdef POI_AUDIOLINK
				audioLinkDecalEmission1 = lerp(float4(0,0,0,0).x, float4(0,0,0,0).y, poiMods.audioLink[(0.0 /*_AudioLinkDecal1EmissionBand*/)]) * poiMods.audioLinkAvailable;
				#endif
				poiFragData.emission += decalColor.rgb * decalColor.a * max((0.0 /*_DecalEmissionStrength1*/) + audioLinkDecalEmission1, 0);
				#endif
				#ifdef GEOM_TYPE_FROND
				decalScale = float4(0.7,1.1,0,0);
				decalRotation = 0;
				...
				if (poiMods.audioLinkAvailable)
				{
					decalScale += lerp(float4(0,0,0,0).xy, float4(0,0,0,0).zw, poiMods.audioLink[(0.0 /*_AudioLinkDecal2ScaleBand*/)]);
					sideMod += lerp(float4(0,0,0,0), float4(0,0,0,0), poiMods.audioLink[(0.0 /*_AudioLinkDecal2SideBand*/)]);
					decalRotation += lerp(float4(0,0,0,0).x, float4(0,0,0,0).y, poiMods.audioLink[(0.0 /*_AudioLinkDecal2RotationBand*/)]);
					decalRotation += AudioLinkGetChronoTime((0.0 /*_DecalRotationCTALType2*/), (0.0 /*_DecalRotationCTALBand2*/)) * (0.0 /*_DecalRotationCTALSpeed2*/) * 360;
				}
				#endif
				#if defined(PROP_DECALTEXTURE2) || !defined(OPTIMIZER_ENABLED)
				uv = decalUV((0.0 /*_DecalTexture2UV*/), float4(1,1,-0.15,0), float4(0.36,0.73,0,0), (90.0 /*_DecalRotation2*/) + decalRotation, (0.0 /*_DecalRotationSpeed2*/), decalScale, float4(0,0,0,0) + sideMod, (0.0 /*_Decal2Depth*/), poiMesh, poiCam);
				ddxuv = ddx(uv);
				ddyuv = ddy(uv);
				if (any(fwidth(uv) > .5))
				{
				...
				decalColor = tex2D(_DecalTexture2, uv + float4(0,0,0,0) * _Time.x, ddxuv, ddyuv) * float4(poiThemeColor(poiMods, float4(1,1,1,1).rgb, (0.0 /*_DecalColor2ThemeIndex*/)), float4(1,1,1,1).a);
				#else
				uv = decalUV((0.0 /*_DecalTexture2UV*/), float4(1,1,-0.15,0), float4(0.36,0.73,0,0), (90.0 /*_DecalRotation2*/) + decalRotation, (0.0 /*_DecalRotationSpeed2*/), decalScale, float4(0,0,0,0) + sideMod, (0.0 /*_Decal2Depth*/), poiMesh, poiCam);
				decalColor = float4(poiThemeColor(poiMods, float4(1,1,1,1).rgb, (0.0 /*_DecalColor2ThemeIndex*/)), float4(1,1,1,1).a);
				#endif
				decalColor.rgb = decalHueShift((0.0 /*_DecalHueShiftEnabled2*/), decalColor.rgb, (0.0 /*_DecalHueShift2*/) + poiLight.nDotV * (0.0 /*_Decal2HueAngleStrength*/), (0.0 /*_DecalHueShiftSpeed2*/));
				decalColor.a *= applyTilingClipping((0.0 /*_DecalTiled2*/), uv) * decalMask[(2.0 /*_Decal2MaskChannel*/)];
				float audioLinkDecalAlpha2 = 0;
				#ifdef POI_AUDIOLINK
				if ((0.0 /*_AudioLinkDecalCC2*/) && poiMods.audioLinkAvailable)
				{
					decalColor.rgb *= AudioLinkLerp(ALPASS_CCSTRIP + float2(uv.x * AUDIOLINK_WIDTH, 0)).rgb;
				}
				audioLinkDecalAlpha2 = lerp(float4(0,0,0,0).x, float4(0,0,0,0).y, poiMods.audioLink[(0.0 /*_AudioLinkDecal2AlphaBand*/)]) * poiMods.audioLinkAvailable;
				#endif
				poiFragData.baseColor.rgb = lerp(poiFragData.baseColor.rgb, customBlend(poiFragData.baseColor.rgb, decalColor.rgb, (0.0 /*_DecalBlendType2*/)), decalColor.a * saturate((1.0 /*_DecalBlendAlpha2*/) + audioLinkDecalAlpha2));
				if ((0.0 /*_DecalOverrideAlpha2*/))
				{
					alphaOverride += 1;
					decalAlpha = lerp(decalAlpha, min(decalAlpha, decalColor.a), decalMask[(2.0 /*_Decal2MaskChannel*/)]);
				}
				float audioLinkDecalEmission2 = 0;
				#ifdef POI_AUDIOLINK
				audioLinkDecalEmission2 = lerp(float4(0,0,0,0).x, float4(0,0,0,0).y, poiMods.audioLink[(0.0 /*_AudioLinkDecal2EmissionBand*/)]) * poiMods.audioLinkAvailable;
				#endif
				poiFragData.emission += decalColor.rgb * decalColor.a * max((0.0 /*_DecalEmissionStrength2*/) + audioLinkDecalEmission2, 0);
				#endif
				if (alphaOverride)
				{
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				#endif
				#ifdef _LIGHTINGMODE_TEXTURERAMP
				poiLight.rampedLightMap = lerp(1, UNITY_SAMPLE_TEX2D(_ToonRamp, poiLight.lightMap + (-0.345 /*_ShadowOffset*/)).rgb, shadowStrength);
				poiLight.finalLighting = lerp(float4(0.7077566,0.7077566,0.7077566,1) * lerp(poiLight.indirectColor, poiLight.rampedLightMap * poiLight.directColor, (0.0 /*_LightingIgnoreAmbientColor*/)) * poiLight.occlusion, poiLight.directColor, poiLight.rampedLightMap);
				#endif
				#endif
				#ifdef POI_PASS_ADD
				...
				if ((1.0 /*_LightingAdditiveType*/) == 1)
				{
					...
					#endif
					if ((0.35 /*_LightingAdditiveGradientEnd*/) == (0.0 /*_LightingAdditiveGradientStart*/)) (0.35 /*_LightingAdditiveGradientEnd*/) += 0.001;
					poiLight.rampedLightMap = smoothstep((0.35 /*_LightingAdditiveGradientEnd*/), (0.0 /*_LightingAdditiveGradientStart*/), 1 - (.5 * poiLight.nDotL + .5));
					#if defined(POINT) || defined(SPOT)
					poiLight.finalLighting = lerp(poiLight.directColor * max(min(poiLight.additiveShadow, poiLight.detailShadow), passthrough), poiLight.indirectColor, smoothstep((0.0 /*_LightingAdditiveGradientStart*/), (0.35 /*_LightingAdditiveGradientEnd*/), 1 - (.5 * poiLight.nDotL + .5))) * poiLight.attenuation;
					#else
					poiLight.finalLighting = lerp(poiLight.directColor * max(min(poiLight.attenuation, poiLight.detailShadow), passthrough), poiLight.indirectColor, smoothstep((0.0 /*_LightingAdditiveGradientStart*/), (0.35 /*_LightingAdditiveGradientEnd*/), 1 - (.5 * poiLight.nDotL + .5)));
					#endif
				}
				...
				for (int index = 0; index < 4; index++)
				{
					...
					{
						vertexLighting += lerp(poiLight.vColor[index] * poiLight.vAttenuation[index], poiLight.vColor[index] * (0.5 /*_LightingAdditivePassthrough*/) * poiLight.vAttenuation[index], smoothstep((0.0 /*_LightingAdditiveGradientStart*/), (0.35 /*_LightingAdditiveGradientEnd*/), .5 * poiLight.vDotNL[index] + .5)) * poiLight.detailShadow;
					}
				}
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				float3 mainNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN(_BumpMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_BumpMapUV*/)], float4(1.2,1.2,0,0)), float4(0,0,0,0)), (0.8 /*_BumpScale*/));
				...
				poiLight.directColor = lerp(poiLight.directColor, dot(poiLight.directColor, float3(0.299, 0.587, 0.114)), (0.45 /*_LightingMonochromatic*/));
				poiLight.indirectColor = lerp(poiLight.indirectColor, dot(poiLight.indirectColor, float3(0.299, 0.587, 0.114)), (0.45 /*_LightingMonochromatic*/));
