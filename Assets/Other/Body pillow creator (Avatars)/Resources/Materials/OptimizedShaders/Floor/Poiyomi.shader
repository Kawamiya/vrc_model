Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi Toon/f1ef71d8cf954f84db8f8b6595c8864a"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				float3 emission0 = 0;
				float emissionStrength0 = (0.45 /*_EmissionStrength*/);
				...
				applyALCenterOutEmission(poiMods, poiLight.nDotV, emissionStrength0, (0.0 /*_AudioLinkEmission0CenterOutSize*/), (0.0 /*_AudioLinkEmission0CenterOutBand*/), float4(0,0,0,0), (0.0 /*_EmissionAL0Enabled*/));
