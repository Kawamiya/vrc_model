Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon/f9d87df08bb43a649868dc5d2e35e7d8"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				float smoothness = (0.874 /*_MochieRoughnessMultiplier*/);
				...
				specularMask *= (0.219 /*_MochieSpecularStrength*/);
				...
				{
					percepRough = GSAA_Filament(poiMesh.normals[(1.0 /*_PBRNormalSelect*/)], percepRough, (0.15 /*_PoiGSAAVariance*/), (0.142 /*_PoiGSAAThreshold*/));
					if ((0.0 /*_Specular2ndLayer*/) == 1 && (1.0 /*_MochieSpecularStrength2*/) > 0)
					{
						percepRough2 = GSAA_Filament(poiMesh.normals[(1.0 /*_PBRNormalSelect*/)], percepRough2, (0.15 /*_PoiGSAAVariance*/), (0.142 /*_PoiGSAAThreshold*/));
					}
				}
